###############################################################################################################################
# Name             : ImprovedRegression
# Date             : 07-15-2015
# Author           : Christopher M
# Dept             : Business Analytics
# Purpose          : Example of how scaling variables will improve regression
...
baseball = read.csv('F:\\Analytics_Process\\R\\SampleData\\Batting.csv',sep=",",header=T)
